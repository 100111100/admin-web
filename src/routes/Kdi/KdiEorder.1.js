...
import { Row, Col, Card, Form, Input, Cascader, Button, Table, Select } from 'antd';
...
@Form.create()
export default class KdiEorder extends SimpleMng {
  constructor() {
    super();
          ...
          <Col md={12} sm={24}>
            <Card title="寄件人信息">
              <Form>
                ...
                <Row>
                  <Col span={24} pull={2}>
                    <FormItem {...senderFormItemLayout} label="省市区" className={styles.formItem}>
            ...
            <div style={{ marginTop: '30px', height: '10px' }}>
              <Card title="选择寄件人">
                <Table
          ...
          <Col md={12} sm={24}>
            <Card title="收件人信息" bordered={false}>
              <Form>
                ...
                <FormItem {...formItemLayout} className={styles.formItem} label="订单详情">
                  {getFieldDecorator('orderDetail', {
                    rules: [
                      {
                        required: false,
                      },
                    ],
                  })(<TextArea style={{ minHeight: 32 }} placeholder="请输入订单详情" rows={4} />)}
                </FormItem>
                ...
                <FormItem {...formItemLayout} className={styles.formItem} label="收件人地址">
